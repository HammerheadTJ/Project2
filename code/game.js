...
var actorChars = {
  ...
  "b": Berry,
  "s": Star,
  "e": Water, "r": Water, "t": Water,
  "q": Acid, "u": Acid, "i": Acid,
...
var wobbleSpeed = 2, wobbleDist = 0.15;
...
var wobbSpeed = 2, wobbDist = 2.50;

Moon.prototype.act = function(step) {
  this.wobble += step * wobbSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
var wobSpeed = 3, wobDist = 2;

Berry.prototype.act = function(step) {
  this.wobble += step * wobSpeed;
  var wobblePos = Math.sin(this.wobble) * wobDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};

var maxStep = 1.05;

var wobbleSpeed = 2, wobbleDist = 0.25;
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  if (obstacle == "portal"){
    this.pos = new Vector(18,8)
  }

  if (obstacle == "portel"){
    this.pos = new Vector(50,20)
  }
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // Player loses
  if ((type == "lava" || type == "water" || type =="acid") && this.status == null) {
    this.status = "lost";
    this.finishDelay = 0;
  ...
  else if (type == "coin" || type == "moon" || type == "berry" || type == "star") {
